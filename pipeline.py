...
best_collaborative_filtering = model_training.collaborative_filtering(train_test_data[0],
                                    **config["model_building"][0]['CF'][1]["params"])

logger.info("Training Content Based Filtering model...")
content_based_filtering = model_training.content_base_filtering(
                            config["model_building"][1]["CBF"][0]["numeric_params"],
                            config["model_building"][1]["CBF"][0]["text_params"],
                            train_test_data[1])
